str = input('Enter the user defined function whose integral is known\n' , 's') ;
disp([' ']) ;
f = inline (str , 'x') ;
...
actual_area = input('Enter the actual area\n') ;
...
area_trap_third = TrapezoidalThirdOrder (f , df1 , df2 , a , b , 100) ;
area_trap_fourth = TrapezoidalFourthOrder (f , df1 , df2 , df3 , a , b , 100) ;
